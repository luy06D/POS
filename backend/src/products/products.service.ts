...
export class ProductsService {
  ...
  async create(createProductDto: CreateProductDto) {
    ...
    //Creamos una copia de createProductDto y le asignamos la categoria
  ...
  async update(id: number, updateProductDto: UpdateProductDto) {
    const product = await this.findOne(id) // findOne para validar su existencia
    Object.assign(product, updateProductDto) // Solo actualiza las propiedades necesaria
